...
class MainWindow(QMainWindow):
    ...
    def alert_config_schema(self):
        return (
            ...
            ("baseline_clean_lock_seconds", "Clean-audio seconds required before baseline locks.", "float", 2.0, 120.0, 0.5),
            ("baseline_min_rms_samples", "Minimum qualifying RMS samples required before baseline locks.", "int", 10, 1000, 1),
            ("baseline_rms_cv_max", "Maximum RMS variation (CV) allowed at lock time.", "float", 0.05, 5.0, 0.01),
            ...
            (
                "enable_subtle_modulation_promotion",
                "Enable experimental subtle low-ambient promotion path.",
                "bool",
                0,
                1,
                1,
