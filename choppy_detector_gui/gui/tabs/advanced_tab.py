...
def build_advanced_tab(window) -> None:
    ...
    window.copy_advanced_clipboard_btn = QPushButton("Copy to Clipboard")
    window.copy_advanced_clipboard_btn.clicked.connect(window.copy_advanced_settings_to_clipboard)
    window.paste_advanced_clipboard_btn = QPushButton("Paste from Clipboard")
    window.paste_advanced_clipboard_btn.clicked.connect(window.paste_advanced_settings_from_clipboard)
    actions.addWidget(window.reset_advanced_defaults_btn)
    actions.addWidget(window.save_advanced_btn)
    actions.addWidget(window.copy_advanced_clipboard_btn)
