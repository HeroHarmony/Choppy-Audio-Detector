...
def build_websocket_tab(window) -> None:
    ...
    target_form.addRow("Source", _wrap_layout(source_row))
    ...
    automation_form.addRow("Auto refresh", window.obs_auto_refresh_enabled)
    ...
    automation_form.addRow("Min severity", window.obs_auto_refresh_min_severity)
    ...
    automation_form.addRow("Cooldown", window.obs_auto_refresh_cooldown_sec)
    ...
    automation_form.addRow("Off/on delay", window.obs_refresh_off_on_delay_ms)
    window.obs_baseline_rebuild_enabled = QCheckBox("Relearn baseline after scene exit")
    automation_form.addRow("Baseline relearn", window.obs_baseline_rebuild_enabled)
    ...
    automation_form.addRow("Watch scene", window.obs_baseline_scene)
    ...
    automation_form.addRow("Min dwell", window.obs_baseline_min_dwell_sec)
    ...
    automation_form.addRow("Exit delay", window.obs_baseline_exit_delay_sec)
    ...
    automation_form.addRow("Cooldown", window.obs_baseline_cooldown_sec)
